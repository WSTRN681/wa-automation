...
exports.listGroupParticipants = listGroupParticipants;
...
function sendMessage(recipient, message, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, whatsapp_1.onConnectionOpen)(socket, () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, whatsapp_1.sendSocketMessage)(socket, whatsappId, whatsappMessage, options);
        }));
    });
}
...
function sendLocation(recipient, latitude, longitude) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, whatsapp_1.onConnectionOpen)(socket, () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, whatsapp_1.terminate)(socket, 3);
        }));
    });
}
...
function me() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, whatsapp_1.onConnectionOpen)(socket, () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, whatsapp_1.terminate)(socket);
        }));
    });
}
function listGroups() {
...
function mutateGroup(groupId, phoneNumber, operation) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, whatsapp_1.onConnectionOpen)(socket, () => __awaiter(this, void 0, void 0, function* () {
            ...
            const updateResult = yield socket.groupParticipantsUpdate(groupId, [whatsAppId], operation);
            updateResult.forEach((entry) => {
                signale_1.default.log(`{"id": "${entry.jid}", "status": "${entry.status}"}`);
            });
            yield (0, whatsapp_1.terminate)(socket);
        }));
    });
}
function listGroupParticipants(groupId) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, whatsapp_1.checkLoggedIn)();
        const socket = yield (0, whatsapp_1.initWASocket)();
        (0, whatsapp_1.onConnectionOpen)(socket, () => __awaiter(this, void 0, void 0, function* () {
            const groupMetadata = yield socket.groupMetadata(groupId);
            groupMetadata.participants.forEach((participant) => {
                signale_1.default.log(`{"id": "${participant.id}"}`);
            });
            yield (0, whatsapp_1.terminate)(socket);
        }));
    });
