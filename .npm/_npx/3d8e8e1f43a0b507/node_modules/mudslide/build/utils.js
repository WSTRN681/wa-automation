...
exports.isValidE164PhoneNumber = isValidE164PhoneNumber;
...
function isValidE164PhoneNumber(s) {
...
function readPhoneNumber() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let result = yield question(query);
        while (!isValidE164PhoneNumber(result)) {
            signale_1.default.error('Invalid phone number.');
            result = yield question(query);
        }
        ri.close();
